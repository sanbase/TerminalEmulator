...
#define ipv4_is_loopback(addr) ((ntohl(addr.s_addr) & 0xFF000000L) == 0x7F000000L)
...
{ 
	...
	*realhost = '\0'; 
	...
	if ((a = inet_addr(host)) == (unsigned long) INADDR_NONE)
	{
		...
		typedef int (CALLBACK * FGETADDRINFO) (const char *nodename, const char *servname, const struct addrinfo * hints, struct addrinfo ** res);
